export const resumeData = {
    ...
    phone: "(+91) 7061221395",
    email: "kumaramitlesliganj30915@gmail.com",
    socials: {
    ...
    skills: [
        ...
        {
            category: "Tools",
            items: ["Git", "SQL", "Firebase", "Cursor", "Material UI"],
        },
        {
            category: "Others",
    ...
    experience: [
        ...
        },
        {
            ...
            achievements: [
                "NinjaCRM is a customer Relationship management interface which facilities multiple usecase of Ninjacart's platform business.",
                "Implemented customer data management, lead tracking, sales pipeline management features.",
                "Integrated notification functionality to facilitate communication with customers directly from the CRM interface.",
            ],
        },
    ],
    projects: [
    ...
    achievements: [
        "Secured 235th position in National Institute of Technology Master of Computer Applications Common Entrance Test (NIMCET) 2021.",
        "Anticipated honed coding skills by solving 600+ challenging problems on LeetCode.",
    ],
};
